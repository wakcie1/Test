...
{
    public class ProblemActionContainmentModel
    {
        public long Id { get; set; }
        public string PACWhat { get; set; }
        public string PACCheck { get; set; }
        ...
        public DateTime? PACVarificationDate { get; set; }
        public string PACVarificationDateDesc
        {
            get
            {
                var date = PACVarificationDate.GetValueOrDefault().ToString("yyyy-MM-dd HH:mm");
                return date == "1900-01-01 00:00" ? string.Empty : date;
            }
        }
        ...
        public int? PACEffeective { get; set; }
